...
# ******************************************************************************
from dlplay.models.linear.logistic_regression import BinaryLogisticRegression
...
def main():
    dataset_name = ToyDatasetType.BREAST_CANCER
    ...
    optimizer_vanilla = GradientDescentVanillaOptimizer(
        name="binary_logistic_regression_vanilla_gd",
        objective_function=model,
        max_iterations=max_iterations,
        learning_rate=learning_rate,
    )
    optimizer_momentum = GradientDescentMomentumOptimizer(
        name="binary_logistic_regression_momentum_gd",
        objective_function=model,
        max_iterations=max_iterations,
        learning_rate=learning_rate,
        momentum=0.9,
