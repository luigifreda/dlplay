...
class RandomHorizontalFlip(T.RandomHorizontalFlip):
    """
    Randomly flip the image and its bounding boxes horizontally.
    """
...
class ToDtype(nn.Module):
    """
    Convert the image to the specified dtype and optionally scale the pixel values.
    """
...
class RandomIoUCrop(nn.Module):
    """
    Randomly crops the image and its bounding boxes to a random size and aspect ratio.
    """
...
class RandomZoomOut(nn.Module):
    """
    Randomly zooms out the image and its bounding boxes.
    """
...
class RandomPhotometricDistort(nn.Module):
    """
    Randomly distorts the image's brightness, contrast, saturation, and hue.
    """
...
class FixedSizeCrop(nn.Module):
    """
    Randomly crops the image and its bounding boxes to a fixed size.
    """
...
class SimpleCopyPaste(torch.nn.Module):
    """
    Simple Copy-Paste data augmentation.
    """
