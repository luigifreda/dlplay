...
class S3DIS(InMemoryDataset):
    ...
    url_backup = "https://cvg-data.inf.ethz.ch/s3dis/Stanford3dDataset_v1.2.zip"
    ...
    def download(self) -> None:
        try:
            ...
            print(e)
            path = download_url(self.url_backup, self.root)
            extract_zip(path, self.root)
            print(f"Downloaded {self.url_backup} successfully")
        os.unlink(path)
        fs.rm(self.raw_dir)
